...
# =============================================================================
TB10753_TEXT = {
    "1 总则": "1.0.1 为加强高速铁路隧道工程施工质量管理,统一验收要求,制定本标准。",
    "2 术语": "2.0.1 检验批：指按同一生产条件或按规定的方式汇总起来供检验用的，由一定数量样本组成的检验体。",
    "3 基本规定": "3.2.1 高速铁路隧道工程施工质量验收应按单位工程、分部工程、分项工程和检验批划分。",
    "4 加固处理": "地表注浆加固、洞内预注浆、隧底加固。",
    "5 洞口工程": "洞口开挖、结构工程、回填、防护工程、检查设施。",
    "6 超前支护": "管棚、超前小导管、水平旋喷桩。",
    "7 洞身开挖": "开挖（同一围岩段且不大于60m）。",
    "8 支护": "喷射混凝土、锚杆、钢筋网、钢架（同一围岩段且不大于60m）。",
    "9 衬砌": "仰拱(底板)和填充、拱墙衬砌，回填注浆（同一围岩段且不大于5个浇筑段）。",
    "10 防水和排水": "洞口防排水、洞内排水设施、结构防水。",
    "11 附属设施": "通风土建工程、疏散救援设施、电缆槽、综合接地。"
}
